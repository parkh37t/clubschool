...
| `_과제운영/과제정의서_Converge서비스화_기획설계.md` | **과제화·경력화** — 창수(Troy) Global-Ready 트랙(AI 페어·영문 i18n 개발), 산출물 D1~D7 |
| `_과제운영/창수-워크스페이스/` | 창수 스타터 킷 — D1 용어집(시드)·D2 i18n 설계·D4-5 개발가이드·D6 AI 플레이북·경력증빙 |
